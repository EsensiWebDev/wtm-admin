        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="font-medium">{support.length}</span>
              {support.length === 1 ? " support" : " supports"} from our
              servers.
            </DialogDescription>
          </DialogHeader>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>
            This action cannot be undone. This will permanently delete your{" "}
            <span className="font-medium">{support.length}</span>
            {support.length === 1 ? " support" : " supports"} from our servers.
          </DrawerDescription>
        </DrawerHeader>
